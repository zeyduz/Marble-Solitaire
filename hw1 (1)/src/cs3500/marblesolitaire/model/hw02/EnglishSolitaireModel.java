...
public class EnglishSolitaireModel implements MarbleSolitaireModel {
  ...
  // note: it didn't mention this in the directions
  // separate case to check for if the game is over and to throw an error if game over
  @Override
  public void move(int fromRow, int fromCol, int toRow, int toCol) throws IllegalArgumentException {
    // if the game is over, you cannot make a move
    if (this.isGameOver()) {
      throw new IllegalArgumentException("Cannot make a move. The game is over.");
    }
