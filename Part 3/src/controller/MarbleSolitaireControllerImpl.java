...
public class MarbleSolitaireControllerImpl implements MarbleSolitaireController {
  ...
  /**
   * Helps in reducing code duplication by displaying board and score.
   * @throws IOException during transmission of messages or board
   */
  private void renderBoardStateHelper() throws IOException {
