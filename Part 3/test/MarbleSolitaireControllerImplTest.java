...
public class MarbleSolitaireControllerImplTest {
  ...
  public void testMockViewWithMultipleInvalidInputsButValidMove() {
    Reader in = new StringReader("-1 4 QUIT 2 quit 4 slkjfs ! idk 4 q");
  ...
  @Test
  public void testGameWithCharMidMoveEuro() {
  ...
  @Test
  public void testGameWithCharMidMoveTriangle() {
  ...
  @Test
  public void testGameDecimalAndOtherInvalidInputsEuro() {
  ...
  @Test
  public void testGameDecimalAndOtherInvalidInputsTriangle() {
    Appendable out = new StringBuilder();
    this.model = new TriangleSolitaireModel();
    MarbleSolitaireController controller =
            new MarbleSolitaireControllerImpl(this.model,
                    new MarbleSolitaireTextView(this.model, out),
                    new StringReader("0.4 3 1 1 -88 1 Q"));
  ...
  @Test
  public void testGameStartQThenMoveEuro() {
    Appendable out = new StringBuilder();
    this.model = new EuropeanSolitaireModel();
    MarbleSolitaireController controller =
            new MarbleSolitaireControllerImpl(this.model,
  ...
  @Test
  public void testGameStartQThenMoveTriangle() {
    Appendable out = new StringBuilder();
    this.model = new TriangleSolitaireModel();
    MarbleSolitaireController controller =
            new MarbleSolitaireControllerImpl(this.model,
